...
def prepare_template_context(cfg):
    ...
    stat_pulse_fidelity_baseline = fl.get_stat_pulse_fidelity(cfg.experiment_right + "/sinq20" )
    ...
    if cfg.mermin_5_plot == True:
        try: 
            ...
            context["plot_mermin"] = pl.mermin_plot(
                raw_data=os.path.join("data", "mermin", cfg.experiment_left, "results.json"),
                expname=f"mermin_{cfg.experiment_left}",
                output_path="build/",
            )
            context["plot_mermin_baseline"] = mermin_5_plot_baseline = pl.mermin_plot(
                raw_data=os.path.join("data", "mermin", cfg.experiment_right, "results.json"),
    ...
    if cfg.grover2q_plot == True:
        try: 
            ...
            context["plot_grover2q"] = pl.plot_grover(
                raw_data=os.path.join("data", "grover2q", cfg.experiment_left, "results.json"),
                expname=f"grover2q_{cfg.experiment_left}",
                output_path="build/",
            )
            context["plot_grover2q_baseline"] = pl.plot_grover(
                raw_data=os.path.join("data", "grover2q", cfg.experiment_right, "results.json"),
    ...
    if cfg.grover3q_plot == True:
        try: 
            ...
            context["plot_grover3q"] = pl.plot_grover(
                raw_data=os.path.join("data", "grover3q", cfg.experiment_left, "results.json"),
                expname=f"grover3q_{cfg.experiment_left}",
                output_path="build/",
            )
            context["plot_grover3q_baseline"] = pl.plot_grover(
                raw_data=os.path.join("data", "grover3q", cfg.experiment_right, "results.json"),
    ...
    if cfg.ghz_plot == True:
        try: 
            ...
            context["plot_ghz"] = pl.plot_ghz(
                raw_data=os.path.join("data", "GHZ", cfg.experiment_left, "results.json"),
                output_path=os.path.join("build", "GHZ", cfg.experiment_left),
            )
            context["plot_ghz_baseline"] = pl.plot_ghz(
                raw_data=os.path.join("data", "GHZ", cfg.experiment_right, "results.json"),
    ...
    if cfg.process_tomography_plot == True:
        try: 
            ...
            context["plot_process_tomography"] = pl.plot_process_tomography(
                ...
                output_path=os.path.join("build", "process_tomography", cfg.experiment_left),
            )
            context["plot_process_tomography_baseline"] = pl.plot_process_tomography(
                ...
                output_path=os.path.join("build", "process_tomography", cfg.experiment_right),
            )
    ...
    if cfg.tomography_plot == True:
        try:
            ...
            context["plot_tomography"] = pl.plot_tomography(
                raw_data=os.path.join("data", "tomography", cfg.experiment_left, "results.json"),
                output_path=os.path.join("build", "tomography", cfg.experiment_left),
            )
            context["plot_tomography_baseline"] = pl.plot_tomography(
                raw_data=os.path.join("data", "tomography", cfg.experiment_right, "results.json"),
    ...
    if cfg.reuploading_classifier_plot == True:
        try:
            ...
            context["plot_reuploading_classifier"] = pl.plot_reuploading_classifier(
                raw_data=os.path.join(
                    "data", "reuploading_classifier", cfg.experiment_left, "results.json"
                ),
                output_path=os.path.join("build", "reuploading_classifier", cfg.experiment_left),
            )
            context["plot_reuploading_classifier_baseline"] = (
                pl.plot_reuploading_classifier(
                    raw_data=os.path.join(
                        "data", "reuploading_classifier", cfg.experiment_right, "results.json"
                    ),
    ...
    if cfg.qft_plot == True:
        try:
            ...
            context["plot_qft"] = pl.plot_qft(
                raw_data=os.path.join("data", "QFT", cfg.experiment_left, "results.json"),
            ...
            context["plot_qft_baseline"] = pl.plot_qft(
                raw_data=os.path.join("data", "QFT", cfg.experiment_right, "results.json"),
