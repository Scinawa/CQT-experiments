...
def create():
    ...
    xy_awg_chan, ro_awg_chan, ro_dig_chan, qb_flux_chan, tc_flux_chan = (
    ...
    for idx, qubit in qubits.items():
        ...
        channels[qubit.drive] = IqChannel(
            device="M5300AWG", path="", mixer=None, lo=None
        )
        ...
        channels[qubit.acquisition] = AcquisitionChannel(
            device="M5200Digitizer", path="", probe=qubit.probe, twpa_pump=None
        )
